...
export interface UniverseERC4626VaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface UniverseERC4626Vault extends BaseContract {
  connect(runner?: ContractRunner | null): UniverseERC4626Vault;
  waitForDeployment(): Promise<this>;

  interface: UniverseERC4626VaultInterface;
