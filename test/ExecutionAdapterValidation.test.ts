  ...
  describe("validateExecutionAdapter - Atomic Checks", function () {
    ...
    describe("Validation in buy() and sell() operations", function () {
      ...
      it("should call atomic validation during buy()", async function () {
        ...
        await expect(erc4626ExecutionAdapter.connect(loSigner).buy(await erc4626Vault.getAddress(), sharesAmount, 0n))
          .to.not.be.reverted;
      ...
      it("should call atomic validation during sell()", async function () {
        ...
        await expect(erc4626ExecutionAdapter.connect(loSigner).sell(await erc4626Vault.getAddress(), sharesAmount, 0n))
          .to.not.be.reverted;
