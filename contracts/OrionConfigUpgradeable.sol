 ...
 *     ╚═════╝ ╚═╝  ╚═╝╚═╝ ╚═════╝ ╚═╝  ╚═══╝    ╚═╝     ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝╚══════╝
 *
 * @title OrionConfigUpgradeable
 * @notice Upgradeable version of OrionConfig using UUPS pattern
 * @author Orion Finance
 * @custom:security-contact security@orionfinance.ai
 */
contract OrionConfigUpgradeable is Initializable, Ownable2StepUpgradeable, UUPSUpgradeable, IOrionConfig {
    using EnumerableSet for EnumerableSet.AddressSet;

    /// @notice Admin address (was immutable in original, now regular storage for upgradeability)
