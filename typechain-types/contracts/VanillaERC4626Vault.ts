...
export namespace MessageSubmittedEvent {
  export type InputTuple = [curator: AddressLike, message: string];
  export type OutputTuple = [curator: string, message: string];
  export interface OutputObject {
    curator: string;
    message: string;
  }
...
export interface FHEIntentsERC4626Vault extends BaseContract {
  ...
  getMessage: TypedContractMethod<[index: BigNumberish], [string], "view">;
  ...
  submitMessage: TypedContractMethod<[message: string], [void], "nonpayable">;
  ...
  filters: {
    ...
    "MessageSubmitted(address,string)": TypedContractEvent<
      MessageSubmittedEvent.InputTuple,
      MessageSubmittedEvent.OutputTuple,
      MessageSubmittedEvent.OutputObject
    >;
